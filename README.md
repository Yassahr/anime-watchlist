...
<ul>
    <li>Adding code so any substring of the title with produce the anime</li>
    <li>Getting a paid tier of Render for fasting loading or implementing a task automation, like cron-job, to hit the server on a resgular basis</li>
</ul>
<!-- Limitations -->
<h2 align="left">Limitations:</h2>
<p>API is being hosted on render and for the free tier has a cold server start. The first request to the server in 30 minutes will take 20-30 seconds to load</p>
<!-- Lessons Learned -->
<h2 align="left">Lessons Learned:</h2>
<p>Creating API using Node.JS </p>
<p>Creating API using Express framework </p>
